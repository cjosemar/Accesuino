...
class PermisoTrabajo extends Model
{
     ...
     * @var string
     */
    protected $table = 'permisostrabajo';
     ...
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function tipopermisotrabajo()
    {
        return $this->belongsTo(TipoPermisoTrabajo::class, 'tipopermisotrabajo_uuid', 'uuid');
    }
